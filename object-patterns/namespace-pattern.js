...
/* (ii). Let's move onto combining a namespace with an IIFE with public and private
 * properties. We return an interface for other developers to use as well as returnin
 * an object literal
 */
