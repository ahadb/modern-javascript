...
> (i). ES6 brings with different methods that help your workflow. Over the years libraries like Underscore and then Lodash have           polyfilled the features lacking in the language, but now we have many more tools for the functional array.

/* Array.from: long overdue method - Creates a new Array instance from an array-like or iterable object */

3.1. Array from string
```javascript
Array.from('string');
// => ["s", "t", "r", "i", "n", "g"]
```
